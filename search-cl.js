// ═══════════════════════════════════════════════════════════════
//  ANASTASIA — CHILE  ·  modulo de busqueda
//  repo: anastasia-cl   ·   va junto con server.js
// ═══════════════════════════════════════════════════════════════
...
const STOP_ES = new Set([
  ...
  "notebook","computador","computadora","pc","asus","favor","gracias","hola","buenas",
  "weon","weón","hueon","hueón","cachai","cachái","poh","bacan","bacán","filete","señor","señora","algo","cosa","tipo","seria","sería","estaria","estaría",
]);
...
// Chile: "palo"/"millon" = 1.000.000 ; "luca"/"gamba"/"mil" = 1.000
const UNITS = { millon: 1e6, millones: 1e6, "millón": 1e6, palo: 1e6, palos: 1e6,
                luca: 1e3, lucas: 1e3, gamba: 1e3, gambas: 1e3, mil: 1e3 };
...
export const USE_PATTERNS = {
  ...
  universidad:  /(universidad|\bla u\b|\buni\b|estudiar|estudio|estudiante|carrera|tesis|colegio|liceo|preu|preuniversitario|escolar|clases|programar|programaci[oó]n|ingenier[ií]a)/i,
  trabajo:      /(trabajo|trabajar|oficina|ofim[aá]tica|excel|contabilidad|negocio|empresa|teletrabajo|home office|facturaci[oó]n|profesional|profesionales|ejecutiv|consultor|trabajo remoto|remoto|viajo por trabajo|reuniones|la pega|\bpega\b|pa la pega|para la pega)/i,
...
const TIPO_PEDIDO = [
  ...
  [/placas? madre|placas? base|motherboard|\bmobo\b|fuentes? de poder|fuentes? de alimentaci[oó]n|\bpsu\b|tarjetas? de video|tarjetas? gr[aá]fica dedicada|componentes?|gabinetes?|disipador/i, "componente"],
